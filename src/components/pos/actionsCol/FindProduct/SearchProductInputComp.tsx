  ...
  return (
    ...
    >
      <input
        ...
        className="flex-1 appearance-none bg-inherit p-2 border border-inherit ltr:rounded-l-md rtl:rounded-r-md outline-none focus:border-red-500 transition-colors duration-300"
      />
...
export default SearchProductInputComp;
